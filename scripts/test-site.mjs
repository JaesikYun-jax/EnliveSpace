...
async function main() {
  ...
  try {
    ...
    const assets = [
      ...
      '/css/style.css',
      '/js/main.js',
      '/images/projects/01-sanun12/living/before-after/01-sanun12-hero-after.webp',
      '/images/projects/02-seongbok/living/before-after/02-seongbok-hero-after.webp',
      '/images/projects/06-pangyo/living/before-after/06-pangyo-hero-after.webp',
